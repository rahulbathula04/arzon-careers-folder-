    ...
    <section id="apply" className="py-20 sm:py-28 border-b border-stone-200 bg-[#FAF8F5]">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <Interactive3dCard
          maxTilt={6}
          depthScale={1.01}
          className="rounded-3xl border border-stone-300 bg-white tone-light p-8 sm:p-14 shadow-2xl text-center space-y-8 relative overflow-hidden"
        >
          <BorderBeam size={260} duration={10} delay={1} colorFrom="#1B3F8B" colorTo="#0D9488" />

          {/* Subtle Top Accent */}
          <div className="absolute top-0 inset-x-0 h-1.5 bg-gradient-to-r from-[#1B3F8B] via-teal-500 to-[#8A6D1F]" />

          <div className="space-y-4 max-w-3xl mx-auto">
            <Card3dLayer translateZ={25} className="flex items-center justify-center gap-2">
              <Floating3dBadge duration={3} delay={0.1}>
                <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-emerald-50 border border-emerald-300 text-emerald-800 font-mono text-[11px] font-bold shadow-xs">
          ...
          <Card3dLayer translateZ={15} className="pt-4 border-t border-stone-200 flex flex-wrap items-center justify-center gap-6 text-xs text-stone-600 font-sans">
            <a
