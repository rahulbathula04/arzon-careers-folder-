...
export function ArzonEventHero({ onReserveClick }: ArzonEventHeroProps) {
  ...
  return (
    <section id="hero" className="relative w-full py-5 sm:py-16 overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-teal-50/60 via-[var(--color-warm-paper)] to-[var(--color-warm-paper)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-left">
            ...
            {/* Live Session Event Metadata Badge & Audience Pill */}
            <div className="flex flex-wrap items-center gap-2">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full tone-dark bg-[#0B1325] text-white font-sans text-xs font-semibold shadow-xs border border-stone-800">
                ...
                <span className="text-stone-400">·</span>
                <span className="text-white font-medium">Sat, 19 Sep @ 6:00 PM IST</span>
              </div>

              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-teal-50 border border-teal-200/90 text-teal-900 font-sans text-[11px] font-bold">
                <GraduationCap className="w-3.5 h-3.5 text-teal-700" />
                <span>For B.Pharm, M.Pharm &amp; Pharm.D</span>
              </div>
            </div>

            {/* Main Headline */}
            <h1 className="font-sans font-black text-3xl sm:text-5xl lg:text-6xl text-[var(--color-arzon-ink)] tracking-tight leading-[1.08]">
            ...
            {/* Subheadline - Answers Problem & Value Proposition */}
            <p className="font-sans text-sm sm:text-lg text-slate-700 leading-relaxed max-w-2xl font-normal">
              Stop settling for ₹10k–15k chemist retail or exhausting medical representative sales. Discover corporate careers in <strong className="text-slate-900 font-bold">Pharmacovigilance, Clinical Research &amp; Clinical Data Management</strong> hiring freshers at <strong className="text-teal-700 font-bold">₹3.5L – ₹7.5L CTC</strong>.
            </p>

            {/* Above-the-fold Dual CTA Buttons */}
            <div className="pt-1 sm:pt-2 space-y-2">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-7 py-3.5 sm:py-4 rounded-full bg-teal-600 hover:bg-teal-500 text-white font-sans text-sm font-bold shadow-lg shadow-teal-600/25 transition-all transform hover:-translate-y-0.5 cursor-pointer min-h-[48px]"
                >
                  <Download className="w-4 h-4" />
                  <span>RESERVE MY FREE SEAT &amp; MAP</span>
              ...
              <p className="font-sans text-xs text-slate-500">
                100% Free Live Session · Instant Google Meet Pass · No course purchase required
              </p>
            </div>
            ...
            <div className="pt-1 flex items-center gap-3">
              ...
              <p className="font-sans text-xs text-slate-600 font-medium">
                <span className="font-bold text-slate-900">500+ Pharmacy Candidates</span> registered across 120+ colleges
              </p>
            </div>
