...
export function generateStarterKitPDF(options?: StarterKitPdfOptions) {
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // PAGES: MODULE 1 - TOP 20 CRO INTERVIEW QUESTIONS & MODEL ANSWERS
  // ═════════════════════════════════════════════════════════════════════════════
  const renderQuestionsPage = (questions: typeof STARTER_KIT_QUESTIONS, titleSuffix: string) => {
    doc.addPage();
  ...
  renderQuestionsPage(STARTER_KIT_QUESTIONS.slice(0, 10), "(Part 1: Questions 1 to 10)");
  renderQuestionsPage(STARTER_KIT_QUESTIONS.slice(10, 20), "(Part 2: Questions 11 to 20)");

  // ═════════════════════════════════════════════════════════════════════════════
  // PAGE: MODULE 2 - ENTERPRISE SOFTWARE WORKFLOW BLUEPRINT
  // ═════════════════════════════════════════════════════════════════════════════
  doc.addPage();
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // PAGE: MODULE 3 - 35+ ATS-OPTIMIZED RESUME KEYWORDS & STRATEGY
  // ═════════════════════════════════════════════════════════════════════════════
  doc.addPage();
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // PAGE: MODULE 4 - 2026 HEALTHCARE FRESHER SALARY BENCHMARK & CITIES
  // ═════════════════════════════════════════════════════════════════════════════
  doc.addPage();
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // PAGE: MODULE 5 - 12-WEEK ZERO-TO-OFFER ROADMAP & WORKSHOP INVITATION
  // ═════════════════════════════════════════════════════════════════════════════
  doc.addPage();
  ...
  const fileName = `Arzon_2026_Healthcare_Career_Starter_Kit_${safeCandidateName}.pdf`;
  doc.save(fileName);
}
