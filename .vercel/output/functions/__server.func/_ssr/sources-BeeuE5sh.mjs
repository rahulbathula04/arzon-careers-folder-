...
function sourcesFor(slug, kind) {
  ...
  return ids.map((id) => SOURCES[id]).filter((s) => Boolean(s));
}
const SOURCE_ENRICHMENT = {
  naukri_pv: {
    verifiedAt: "2025-11-18",
    rationale: "Largest India-native JD board; scraped monthly with n≥400 postings per role. Titles + tools + cities are pulled verbatim from live employer requisitions.",
    snippets: [
  ...
  ambitionbox_pv: {
    ...
    rationale: "Self-reported salaries with 1.2k+ data points for the exact PV Associate title. We report the interquartile range, not the mean, to avoid inflation from outliers.",
    snippets: [
  ...
  ambitionbox_coding: {
    ...
    rationale: "Medical Coder is a well-defined title on AmbitionBox with tight distribution; used for Y0 anchor.",
  ...
  talent500_gcc: {
    ...
    rationale: "GCC-focused report explaining the 20-40% premium over Indian pharma CROs for the same title.",
    snippets: ["GCC PV / CDM roles pay 22-38% above domestic CRO median at same experience."]
  },
  nasscom_gcc: {
    verifiedAt: "2025-09-01",
    rationale: "NASSCOM's flagship report on India Global Capability Centres — used for demand-growth curves."
  },
  iqvia_2025: {
    verifiedAt: "2025-04-20",
    rationale: "IQVIA Institute's Global Use of Medicines forecast — anchors 10-year demand curves for clinical / PV roles."
  },
  nasscom_bpm: {
    verifiedAt: "2025-07-10",
    rationale: "India BPM Healthcare vertical growth — corroborates Naukri JD volume trends for coding / PV."
  },
  linkedin_hiring_pulse: {
    verifiedAt: "2025-11-05",
    rationale: "LinkedIn Economic Graph — used only as a directional signal (hiring intent), never as a salary source."
  },
  internal_jd: {
    verifiedAt: "2025-11-20",
    rationale: "Arzon's internal JD board mirrors LinkedIn + Naukri for six shipping roles. Refreshed weekly."
  },
  arzon_employer_desk: {
    verifiedAt: "2025-11-14",
    rationale: "Quarterly briefings with hiring managers at IQVIA, Parexel, Cognizant, Accenture, ICON. Notes are anonymised."
  },
...
function computeReportFreshness() {
  let best = "";
  let count = 0;
