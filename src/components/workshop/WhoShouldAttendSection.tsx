...
export function WhoShouldAttendSection({ onReserveClick }: WhoShouldAttendSectionProps) {
  const forYou = [
    ...
    "You want to understand the market before investing months of time or money.",
  ];
  ...
  const notForYou = [
    ...
    "You are looking only for a generic motivational webinar without hard data.",
    ...
    <section className="w-full bg-[var(--color-warm-paper)] py-14 sm:py-20 border-b border-[var(--color-border-warm)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-stone-300 text-slate-900 font-mono text-xs font-bold uppercase tracking-wider mb-2">
          ...
          <p className="font-sans text-xs sm:text-sm text-stone-600 mt-2">
            We maintain high-intent criteria so every participant receives maximum strategic value.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          ...
          <div className="bg-white tone-light rounded-3xl p-6 sm:p-8 border border-emerald-200 shadow-md">
            ...
            <div className="space-y-3.5">
              {forYou.map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 text-xs sm:text-sm text-stone-700 font-sans leading-relaxed">
          ...
          <div className="bg-stone-50 rounded-3xl p-6 sm:p-8 border border-stone-300 shadow-xs">
            ...
            <div className="space-y-3.5">
              {notForYou.map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 text-xs sm:text-sm text-stone-600 font-sans leading-relaxed">
        ...
        <div className="text-center">
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-[#FF6525] hover:bg-[#e05318] text-white font-mono text-xs font-bold uppercase tracking-wider shadow-lg transition-all cursor-pointer"
            style={{ color: '#FFFFFF' }}
          >
