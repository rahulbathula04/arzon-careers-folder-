...
const services = {
  ["ssr"]: lazyService(() => import("./_ssr/server-BKkhNWog.mjs").then(function(n) {
    return n.i;
  }))
};
...
const _lazy_Ab121j = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_Ab121j };
  return ((_m, p) => {
