import { w as withoutTrailingSlash, W as validateBaseURL, l as loadOptionalSetting, h as withUserAgentSuffix, X as loadApiKey, s as serializeModelOptions, Y as parseProviderOptions, Z as isCustomReasoning, _ as createToolNameMapping, p as postJsonToApi, b as combineHeaders, V as generateId, H as validateTypes, $ as getTopLevelMediaType, a0 as resolveFullMediaType, a1 as convertToBase64, a2 as isNonNullable, a3 as parseJSON, a4 as resolveProviderReference, a as createJsonResponseHandler, i as createEventSourceResponseHandler, k as lazySchema, c as createJsonErrorResponseHandler, z as zodSchema, j as createProviderExecutedToolFactory, a5 as StreamingToolCallTracker, a6 as postFormDataToApi, a7 as convertToFormData, t as convertBase64ToUint8Array, a8 as downloadBlob, a9 as mediaTypeToExtension, aa as toWebSocketUrl, ab as createBinaryResponseHandler, ac as convertInlineFileDataToUint8Array, ad as createProviderDefinedToolFactoryWithOutputSchema, n as connectToWebSocket, I as safeParseJSON, ae as createProviderDefinedToolFactory, u as waitForWebSocketBufferDrain } from "./ai-sdk__provider-utils.mjs";
import { A as APICallError, U as UnsupportedFunctionalityError, e as TooManyEmbeddingValuesForCallError, c as InvalidPromptError } from "./ai-sdk__provider.mjs";
import { W as WORKFLOW_SERIALIZE, a as WORKFLOW_DESERIALIZE } from "./workflow__serde.mjs";
import { o as object, a as string, c as union, n as number, e as any, _ as _enum, d as discriminatedUnion, l as literal, b as array, f as boolean, g as lazy, r as record, u as unknown, j as _null, m as number$1 } from "./zod.mjs";
...
var computerActionSchema = discriminatedUnion("type", [
  object({
    type: literal("click"),
    button: _enum(["left", "right", "wheel", "back", "forward"]),
    x: number(),
    y: number(),
  ...
  object({
    type: literal("drag"),
    path: array(object({ x: number(), y: number() })),
    keys: array(string()).optional()
  }),
  object({
...
var computerInputSchema = lazySchema(
  () => zodSchema(
    object({
...
var computerOutputSchema = lazySchema(
  () => zodSchema(
    object({
      output: union([
        object({
          ...
          detail: _enum(["auto", "low", "high", "original"]).optional()
        }),
        object({
          type: literal("computer_screenshot"),
          fileId: string(),
...
var programmaticToolCallingInputSchema = lazySchema(
  () => zodSchema(
    object({
      code: string(),
      fingerprint: string()
...
var programmaticToolCallingOutputSchema = lazySchema(
  () => zodSchema(
    object({
      result: string(),
...
var openaiResponsesToolCallerSchema = discriminatedUnion("type", [
  ...
  () => zodSchema(
    object({
      ...
      streaming: object({
         ...
         */
        delay: _enum(["minimal", "low", "medium", "high", "xhigh"]).optional(),
        /**
...
var openaiSkillResponseSchema = lazySchema(
  () => zodSchema(
    object({
      id: string(),
      name: string().nullish(),
