...
export interface TrackRubric {
  ...
  title: string;
  jdRole: string;
  /** The 2-3 graded deliverables a student must clear to be awarded the certificate. */
  gradedDeliverables: string[];
  rows: RubricRow[];
}

export const GRADING_RUBRIC: TrackRubric[] = [
  {
    ...
    rows: [
      {
        ...
        cutoff: "≥ 90 %",
        jdOutcome:
          "Owns ICSR end-to-end at ≥ 95% accuracy, MedDRA-codes without supervisor edits, drafts narrative + aggregate sections without rework.",
      ...
      },
      {
        ...
        cutoff: "60-74 %",
        jdOutcome:
          "Completes intake + coding but needs supervised QC on every case, narrative requires major rewrite.",
    ...
    rows: [
      {
        ...
        cutoff: "≥ 90 %",
        jdOutcome:
          "Production accuracy ≥ 95% on the timed chart set, E/M leveling matches auditor, NCCI edits caught.",
    ...
    rows: [
      {
        ...
        cutoff: "≥ 90 %",
        jdOutcome:
          "Builds CDASH-aligned CRFs, writes executable edit-checks, runs SAE recon clean. Knows ICH-GCP at audit depth.",
      ...
      },
      {
        ...
        cutoff: "75-89 %",
        jdOutcome:
          "Executes the build with senior review, query rate within target, edit-checks need minor patching.",
      ...
      },
      {
        ...
        cutoff: "60-74 %",
        jdOutcome:
          "Can clean data and raise queries; build / edit-check authoring still supervised.",
    ...
    rows: [
      {
        ...
        cutoff: "≥ 90 %",
        jdOutcome:
          "Builds SDTM + ADaM + TLFs that pass Pinnacle 21 first time, defines traceability cleanly.",
    ...
    rows: [
      {
        ...
        cutoff: "≥ 90 %",
        jdOutcome:
          "Drafts eCTD-ready sections, runs Veeva Vault RIM cleanly, responds to deficiency letters with citations.",
      ...
      },
      {
        ...
        cutoff: "75-89 %",
        jdOutcome:
          "Drafts sections with reviewer edits, labeling QC accurate, RIM tool comfortable.",
    ...
    rows: [
      {
        ...
        cutoff: "≥ 90 %",
        jdOutcome:
          "Writes CSR sections to ICH E3, narratives need only editorial polish, lit-search workflow clean.",
      ...
      },
      {
        ...
        cutoff: "75-89 %",
        jdOutcome:
          "Drafts narratives + sections with senior review; AI-assist guardrails followed.",
...
export const RUBRIC_BY_SLUG: Record<string, TrackRubric> = Object.fromEntries(
