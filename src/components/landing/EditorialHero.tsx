    ...
    <section className="relative pt-28 pb-16 sm:pt-36 sm:pb-24 border-b border-stone-200 bg-[#FAF8F5] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 h-12 px-6 rounded-xl bg-[#1B3F8B] hover:bg-[#153270] text-slate-50 font-bold text-xs tracking-wide transition-all shadow-md cursor-pointer"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 h-12 px-5 rounded-xl bg-white tone-light hover:bg-stone-100 text-stone-900 border border-stone-300 font-bold text-xs tracking-wide transition-all shadow-2xs cursor-pointer"
              >
          ...
          <div className="lg:col-span-4 rounded-2xl border border-stone-200 bg-white tone-light p-5 sm:p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {DEGREE_SEGMENTS.map((deg) => (
                <button
                  ...
                  className={`px-3 py-2 rounded-lg text-xs font-bold font-sans transition-all text-left truncate cursor-pointer ${
            ...
            <div className="rounded-xl bg-[#FAF8F5] border border-stone-200 p-3.5 space-y-2 text-xs">
              <div>
              ...
              <p className="text-[11px] text-stone-600 font-sans leading-relaxed pt-1 border-t border-stone-200">
