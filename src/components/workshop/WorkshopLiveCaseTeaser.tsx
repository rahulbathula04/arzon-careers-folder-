    ...
    <section className="py-16 sm:py-20 border-b border-stone-200 bg-[#0B1325] text-white tone-dark">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="rounded-2xl border border-stone-700/80 bg-stone-900/90 overflow-hidden shadow-2xl max-w-4xl mx-auto">
          ...
          <div className="px-3.5 sm:px-4 py-2.5 sm:py-3 bg-stone-950 border-b border-stone-800 flex items-center justify-between gap-2">
            <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
              ...
              <span className="font-mono text-[10px] sm:text-xs text-stone-400 ml-1 sm:ml-2 truncate">
                ARZON-VIRTUAL-LAB · ORACLE_ARGUS_ICSR_TRIAGE.LOG
              </span>
            </div>
            <span className="font-mono text-[9px] sm:text-[10px] text-emerald-400 font-bold bg-emerald-950/80 px-2 py-0.5 rounded border border-emerald-500/30 shrink-0">
              SIMULATION READY
            </span>
          </div>

          {/* Terminal Content */}
          <div className="p-4 sm:p-8 space-y-5 sm:space-y-6 font-mono text-xs sm:text-sm">
            <div className="space-y-2 border-b border-stone-800 pb-5">
              <span className="text-stone-400 block text-[11px] sm:text-xs">// STEP 01: INCOMING ADVERSE EVENT REPORT</span>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 text-stone-200 text-xs">
                <div>
            ...
            <div className="space-y-3 border-b border-stone-800 pb-5">
              <span className="text-stone-400 block text-[11px] sm:text-xs">// STEP 02: THE 4 VALIDITY CRITERIA (ICH-E2D COMPLIANCE)</span>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[11px] sm:text-xs">
                <div className="p-2 sm:p-2.5 rounded-lg bg-stone-950 border border-stone-800 flex items-center gap-1.5 text-emerald-400">
                  <CheckCircle2 className="w-3.5 h-3.5 shrink-0" />
                  <span className="truncate">Identifiable Patient</span>
                </div>
                <div className="p-2 sm:p-2.5 rounded-lg bg-stone-950 border border-stone-800 flex items-center gap-1.5 text-emerald-400">
                  <CheckCircle2 className="w-3.5 h-3.5 shrink-0" />
                  <span className="truncate">Identifiable Reporter</span>
                </div>
                <div className="p-2 sm:p-2.5 rounded-lg bg-stone-950 border border-stone-800 flex items-center gap-1.5 text-emerald-400">
                  <CheckCircle2 className="w-3.5 h-3.5 shrink-0" />
                  <span className="truncate">Suspect Drug</span>
                </div>
                <div className="p-2 sm:p-2.5 rounded-lg bg-stone-950 border border-stone-800 flex items-center gap-1.5 text-emerald-400">
                  <CheckCircle2 className="w-3.5 h-3.5 shrink-0" />
                  <span className="truncate">Adverse Event</span>
                </div>
              </div>
            </div>

            <div className="space-y-2">
              <span className="text-stone-400 block text-[11px] sm:text-xs">// STEP 03: REGULATORY TIMELINE CLOCK DECISION</span>
              <div className="p-3 sm:p-3.5 rounded-xl bg-amber-950/40 border border-amber-500/30 flex items-start sm:items-center gap-2.5 sm:gap-3 text-amber-200">
          ...
          {/* Terminal Bottom CTA */}
          <div className="p-4 bg-stone-950 border-t border-stone-800 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-2 text-xs text-stone-300 font-sans text-center sm:text-left">
            ...
            <button
              ...
              className="w-full sm:w-auto min-h-[44px] px-5 py-2.5 rounded-xl bg-[#1B3F8B] hover:bg-blue-600 text-white font-mono text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-md"
            >
