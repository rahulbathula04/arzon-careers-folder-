      ...
      <section className="border-b border-slate-200/80">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
          ...
          <div className="mt-8 rounded-3xl border border-slate-200/80 bg-white p-6 shadow-xl max-w-3xl space-y-4">
             <h2 className="text-lg font-bold text-[#151C2E]">Not sure where to start? Tell us your goal.</h2>
             <div className="flex flex-wrap gap-3">
                <Link to="/career-engine/start" className="inline-flex items-center justify-center rounded-full bg-slate-50 hover:bg-slate-100 px-4 py-2 text-xs sm:text-sm font-bold text-[#151C2E] border border-slate-200 transition-colors">
             ...
             <p className="text-xs text-[#5B6472]">Take a 3-minute assessment to get a personalized, data-driven learning path.</p>
          </div>
        </div>
      </section>
