...
function CopilotTerminal() {
  ...
  const storedProfile = typeof window !== "undefined"
    ? (() => { try { return JSON.parse(sessionStorage.getItem("ce_result") || "null"); } catch { return null; } })()
    : null;
    ...
    <div className="flex min-h-dvh flex-col bg-[#050A15] text-slate-300">
      <header className="flex h-16 items-center justify-between border-b border-white/5 bg-white/[0.01] px-6">
        <div className="flex items-center gap-3">
          ...
          <span className="font-mono text-sm font-semibold tracking-widest text-white uppercase">Arzon Copilot Terminal</span>
        </div>
