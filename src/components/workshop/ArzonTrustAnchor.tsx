import { ShieldCheck, Award, FileCheck, Users, ArrowRight, CheckCircle2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {trustPillars.map((p) => {
            ...
            return (
              <div
                key={p.title}
                className="rounded-2xl border border-slate-800 bg-slate-900 p-6 flex flex-col justify-between hover:border-slate-700 transition-all"
              >
                <div>
                  <div className="p-3 rounded-xl border border-slate-800 bg-slate-950 text-blue-400 w-fit mb-4">
                ...
                <div className="mt-4 pt-3 border-t border-slate-800 flex items-center gap-1.5 text-xs font-mono text-emerald-400">
