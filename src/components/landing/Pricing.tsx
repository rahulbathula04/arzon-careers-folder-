...
/**
 * Section Seven — Tiered Enrollment Engine ($1B+ Startup UI/UX)
 * Interactive payment frequency toggle, side-by-side feature matrix,
 * 3D high-contrast cards, and 100% transparent interview guarantee.
 */
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl space-y-12">
        ...
        {/* 3 Tier Cards with Interactive 3D Tilt */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          {/* Card 1 — Foundation Track (Self-Paced) */}
          <Interactive3dCard
            maxTilt={10}
            depthScale={1.02}
            containerClassName="h-full"
            className="rounded-3xl border border-stone-300 bg-white tone-light card-light p-6 sm:p-8 flex flex-col justify-between space-y-6 shadow-sm hover:shadow-xl hover:border-[#1B3F8B]/40 transition-all h-full"
          >
            <div className="space-y-4">
              ...
              <Card3dLayer translateZ={30}>
                <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#1A1A1A]">Foundation Track</h3>
              </Card3dLayer>
          ...
          {/* Card 2 — Recruiter Track (MOST POPULAR / HIGHLIGHTED) */}
          <Interactive3dCard
            maxTilt={10}
            depthScale={1.04}
            containerClassName="h-full"
            className="relative rounded-3xl border-2 border-[#1B3F8B] bg-white tone-light card-light p-6 sm:p-8 flex flex-col justify-between space-y-6 shadow-2xl ring-4 ring-[#1B3F8B]/10 lg:-translate-y-2 overflow-hidden h-full"
          >
            ...
            <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-30">
              <Floating3dBadge duration={3.5} delay={0.1}>
                <div className="bg-[#1B3F8B] text-white font-mono text-[10px] font-extrabold uppercase tracking-widest px-4 py-1.5 rounded-full shadow-lg flex items-center gap-1.5 border border-sky-400/40">
            ...
            <div className="space-y-4 pt-2">
              ...
              <Card3dLayer translateZ={30}>
                <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#1A1A1A]">Recruiter Track</h3>
              </Card3dLayer>
              <Card3dLayer translateZ={35}>
                <div>
              ...
              <Card3dLayer translateZ={25}>
                <div className="bg-[#0F1A34] border border-sky-400/40 p-4 rounded-2xl text-xs font-mono font-bold leading-snug shadow-md flex items-center gap-2">
              ...
              <Card3dLayer translateZ={20}>
                <ul className="space-y-3 pt-2 text-xs text-stone-800 font-medium">
                  <li className="flex items-start gap-2.5 font-bold text-[#1A1A1A]">
                    ...
                    <span>Everything in Foundation Track</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <Check className="h-4 w-4 text-[#1B3F8B] shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-2.5">
                    <Check className="h-4 w-4 text-[#1B3F8B] shrink-0 mt-0.5" />
                    <span>Partner Desk candidate routing &amp; 1:1 interview mocks</span>
                  </li>
                </ul>
              </Card3dLayer>
            </div>
          ...
          {/* Card 3 — 1-on-1 Track (ELITE SLA) */}
          <Interactive3dCard
            maxTilt={10}
            depthScale={1.02}
            containerClassName="h-full"
            className="relative rounded-3xl border border-amber-300/80 bg-white tone-light card-light p-6 sm:p-8 flex flex-col justify-between space-y-6 shadow-xl overflow-hidden h-full"
          >
            <BorderBeam colorFrom="#F59E0B" colorTo="#D97706" duration={12} delay={3} borderWidth={1.5} />
            
            {/* Top Ribbon Badge */}
            <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-30">
              <Floating3dBadge duration={4} delay={0.3}>
                <div className="bg-amber-600 text-white font-mono text-[10px] font-extrabold uppercase tracking-widest px-4 py-1.5 rounded-full shadow-lg flex items-center gap-1.5 border border-amber-400/40">
            ...
            <div className="space-y-4 pt-2">
              ...
              <Card3dLayer translateZ={30}>
                <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#1A1A1A]">1-on-1 Track</h3>
              </Card3dLayer>
              <Card3dLayer translateZ={35}>
                <div>
              ...
              {/* Feature Callout Pill */}
              <Card3dLayer translateZ={25}>
                <div className="bg-[#241300] border border-amber-500/50 p-4 rounded-2xl text-xs font-mono font-bold leading-snug shadow-md flex items-center gap-2">
              ...
              <Card3dLayer translateZ={20}>
                <ul className="space-y-3 pt-2 text-xs text-stone-800 font-medium">
                  <li className="flex items-start gap-2.5 font-bold text-[#1A1A1A]">
                    ...
                    <span>Everything in Recruiter Track</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <Check className="h-4 w-4 text-amber-600 shrink-0 mt-0.5" />
                ...
                <table className="w-full text-left text-xs font-sans border-collapse">
                  <thead>
                    <tr className="border-b border-stone-200">
                      ...
                      <th className="py-3 px-4 font-mono font-bold text-stone-700 uppercase text-center">Foundation Track</th>
                      <th className="py-3 px-4 font-mono font-bold text-[#1B3F8B] uppercase text-center bg-[#1B3F8B]/5">Recruiter Track</th>
                      <th className="py-3 px-4 font-mono font-bold text-amber-900 uppercase text-center">1-on-1 Track</th>
                    </tr>
                  </thead>
        ...
        <div className="rounded-3xl border border-stone-300 bg-white tone-light card-light p-6 sm:p-8 space-y-4 shadow-sm">
          ...
          <p className="text-xs sm:text-sm text-stone-700 leading-relaxed font-sans">
            ...
            between Recruiter Track and 1-on-1 Track pricing. This is documented in the refund policy and visible in our public trust ledger.
          </p>
        </div>
      </div>
    </section>
