...
const PROOF_TILES = [
  {
    ...
    headline: "Tier-1 Enterprise Tech & Quant Fintechs",
    desc: "Official recruitment partner desks across Tier-1 Tech Enterprises & Quant Fintechs, effective July 2026. VMO ID visible on request.",
  ...
  },
  {
    ...
    desc: "We do this because Tier-1 tech enterprises expect us to present only qualified candidates. Accepting everyone would destroy the partnership. We take selectivity seriously.",
