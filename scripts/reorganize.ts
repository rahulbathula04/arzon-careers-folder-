...
for (const [compDir, feature] of Object.entries(componentFeatureMap)) {
  ...
  const targetDirPath =
    feature === "core"
      ? `src/core/components/${compDir}`
      : `src/features/${feature}/components/${compDir}`;
...
if (libDir) {
  ...
  for (const file of libFiles) {
    ...
    if (lowerName.includes("admin") || lowerName.includes("leads") || lowerName.includes("cohort"))
      targetFeature = "admin";
    else if (lowerName.includes("apply") || lowerName.includes("application"))
      targetFeature = "applications";
    else if (
      lowerName.includes("careerengine") ||
      lowerName.includes("acri") ||
      lowerName.includes("prime")
    )
      targetFeature = "careerEngine";
    else if (
      lowerName.includes("enrol") ||
      lowerName.includes("payment") ||
      lowerName.includes("razorpay")
    )
      targetFeature = "enrolment";
    else if (
      ...
      lowerName.includes("credibility") ||
