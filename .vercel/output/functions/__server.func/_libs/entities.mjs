...
function requireDecode_codepoint() {
  ...
  (function(exports$1) {
    ...
    exports$1.replaceCodePoint = replaceCodePoint2;
    function decodeCodePoint(codePoint) {
      return (0, exports$1.fromCodePoint)(replaceCodePoint2(codePoint));
    }
...
function requireDecode() {
  ...
  (function(exports$1) {
    ...
    })(DecodingMode2 = exports$1.DecodingMode || (exports$1.DecodingMode = {}));
    var EntityDecoder2 = (
      /** @class */
      (function() {
    ...
    exports$1.determineBranch = determineBranch2;
    var htmlDecoder = getDecoder2(decode_data_html_js_1.default);
    var xmlDecoder = getDecoder2(decode_data_xml_js_1.default);
...
var decodeExports = requireDecode();
