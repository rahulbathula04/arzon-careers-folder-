...
export function getRootHead() {
  return {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Caveat:wght@600;700&family=Space+Grotesk:wght@500;600;700&display=swap",
      },
      {
        rel: "preload",
        as: "style",
