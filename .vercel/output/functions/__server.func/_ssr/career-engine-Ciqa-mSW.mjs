...
import { h as hydrateCareerEngineSnapshot, g as consumeExpiredNotice, i as isAttemptExpired, r as resetCareerEngineState, p as persistCareerEngineSnapshot } from "./router-CvdLERTV.mjs";
  ...
  reactExports.useEffect(() => {
    ...
    if (consumeExpiredNotice()) {
      toast.message("Your previous attempt expired", {
        description: "It's been a while since you started, we've reset the test so you can begin fresh."
      });
    }
    if (isAttemptExpired()) {
...
export {
  CareerEngineLayout as component
};
