...
export function TaskPartnershipBlock() {
  ...
  return (
    <section
      ...
      className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-slate-950 text-slate-100 border-b border-slate-800"
    >
      <div className="mx-auto max-w-7xl space-y-12 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="rounded-3xl border border-slate-700/80 bg-slate-900/90 p-6 sm:p-8 flex flex-col justify-between space-y-6 shadow-2xl hover:border-sky-400/50 transition-all duration-300 ring-1 ring-white/5">
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-serif text-xl sm:text-2xl font-bold text-white">Tier-1 Enterprise Tech</h3>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs font-mono text-slate-200 bg-slate-950 p-4 rounded-xl border border-slate-800 shadow-inner">
                <div>
                  <span className="text-slate-400 block text-[10px] uppercase font-bold">Execution Date</span>
                  <span className="font-bold text-white text-xs sm:text-sm">01 May 2024</span>
                </div>
                <div>
                  <span className="text-slate-400 block text-[10px] uppercase font-bold">Status</span>
                  <span className="font-bold text-emerald-400 text-xs sm:text-sm flex items-center gap-1">
                    <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" /> Active Partner
                  </span>
                </div>
                <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-[11px] font-mono text-slate-400 px-1">
                ...
                <span className="text-slate-500">HASH #84F2-E910</span>
              </div>
              <div 
                className="group relative rounded-2xl overflow-hidden border border-slate-700 bg-slate-950 p-3 sm:p-4 cursor-pointer shadow-xl hover:border-sky-400/60 transition-all duration-300"
          ...
          <div className="rounded-3xl border border-slate-700/80 bg-slate-900/90 p-6 sm:p-8 flex flex-col justify-between space-y-6 shadow-2xl hover:border-emerald-400/50 transition-all duration-300 ring-1 ring-white/5">
            <div className="space-y-5">
              {/* Card Header */}
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-serif text-xl sm:text-2xl font-bold text-white">Global Quant Fintech</h3>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs font-mono text-slate-200 bg-slate-950 p-4 rounded-xl border border-slate-800 shadow-inner">
                <div>
                  <span className="text-slate-400 block text-[10px] uppercase font-bold">Execution Date</span>
                  <span className="font-bold text-white text-xs sm:text-sm">30 July 2026</span>
                </div>
                <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-[11px] font-mono text-slate-400 px-1">
                ...
                <span className="text-slate-500">HASH #91C3-A88B</span>
              </div>
              <div 
                className="group relative rounded-2xl overflow-hidden border border-slate-700 bg-slate-950 p-3 sm:p-4 cursor-pointer shadow-xl hover:border-emerald-400/60 transition-all duration-300"
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900/90 p-6 sm:p-10 space-y-8 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Step 1 */}
            <div className="p-5 rounded-2xl border border-slate-800 bg-slate-950 space-y-3 relative">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-mono font-bold text-slate-400 uppercase">Benchmark</span>
              </div>
            ...
            <div className="p-5 rounded-2xl border border-slate-800 bg-slate-950 space-y-3 relative">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-mono font-bold text-slate-400 uppercase">Partner Desk</span>
              </div>
              <h4 className="font-serif text-base font-bold text-white leading-snug">
            ...
            <div className="p-5 rounded-2xl border border-slate-800 bg-slate-950 space-y-3 relative">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-mono font-bold text-slate-400 uppercase">Fast-Track</span>
              </div>
              <h4 className="font-serif text-base font-bold text-white leading-snug">
            ...
            <div className="p-5 rounded-2xl border border-slate-800 bg-slate-950 space-y-3 relative">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-mono font-bold text-slate-400 uppercase">Interview</span>
              </div>
              <h4 className="font-serif text-base font-bold text-white leading-snug">
          ...
          <p className="text-xs font-mono text-slate-400 border-t border-slate-800 pt-4 text-center">
